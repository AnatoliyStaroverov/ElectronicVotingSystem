...
import VotingBanner from "assets/img/voting-banner.png"; 
  ...
  return (
    <div>
      <Header
        ...
        {...rest}
      />
      <Parallax image={require("assets/img/Background_Blue.png")}>
        <div className={classes.container} style={{marginRight: "0px", marginTop: "-19px"}}>
          <GridContainer>
            <GridItem>
